    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <div class="d-flex">
                ...
                <img src="./product_images/<?php echo $product_image1 ?>" alt="" class="product-image w-50 m-auto">
            </div>
        ...
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <div class="d-flex">
                <input type="file" id="product_image2" name="product_image1" class="form-control w-90 m-auto" >
                <img src="./product_images/<?php echo $product_image2 ?>" alt="" class="product-image w-50  m-auto">
            </div>
...
if(isset($_POST['edit_product'])){
    ...
    //cecking for fileds empty or not
    if($product_title=='' or $product_description==''  or $product_keywords=='' or $product_category=='' or $product_brands=='' or $product_price=='' or $product_image1=='' or $product_image2=='' ){
